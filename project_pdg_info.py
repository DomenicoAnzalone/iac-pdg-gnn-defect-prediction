...
def dict_repository_commits():
    ...
    # TODO: replace the line below to process all repo. It's a testing line to process only one repo
    repo_cloned = ["ansible-nginx"]
    repo_cloned.sort()
    ...
    for repoName in repo_cloned:
        ...
        # TODO: remove the line below to process all commits. It's a testing line to process only one commit
