...
def main() -> None:
    ...
    for model in models:
        ...
        save_experiment_outputs(run_dir, "e2", canonical, model_predictions, model_metrics, model_features)
    write_summary(run_dir, "E2 Tabular PDG", config)
    logger.info("E2 completato. Report: %s", run_dir / "reports" / "run_summary.md")
